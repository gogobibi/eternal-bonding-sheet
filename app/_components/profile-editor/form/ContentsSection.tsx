      ...
      <div className="space-y-3">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1">
              {myCustom.map((kw) => (
                <span
                  key={kw.id}
                  className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] border ${theme.keywordTag} ${kw.emphasized ? "font-bold" : ""}`}
                >
                  {kw.text}
                  <button
                    onClick={() => removeMyKeyword(kw.id)}
                    className={theme.keywordRemove}
                  >
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-3 py-2 border rounded-lg transition-colors flex items-center ${theme.keywordAdd}`}
          >
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            ...
            className={`relative inline-flex h-4 w-7 shrink-0 items-center rounded-full transition-colors ${
              youContentsEnabled ? theme.toggleOn : "bg-stone-200"
            }`}
          >
            <span
